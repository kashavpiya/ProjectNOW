        ...
        <div class="aboutpage">
            <div class="left-content">
                ...
                <div style="text-align: center;">
                    <img src="img/image_homeless1.jpg" class="good1">
                    </div>
                ...
                <p>Transitional Housing has three main programs:<ul>
                    <li>Transitional Housing for Families</li><br>
                    <li>Transitional Housing for Youth</li><br>
                    <li>Sojourner House for Women</li>
                </ul></p>
                
                <h3>Transitional Housing for Families:</h3>
                <ul>
                    <li>Up to a Two Year Program</li><br>
                    <li>Participants Are Required to Work or Attend School</li><br>
                    <li>Supportive and Preventative Services</li><br>
                    <li>Job Coaching to Help Increase Earning Potential</li><br>
                    <li>Families Are Required to Pay Utilities and Program Fees</li>
                </ul>
                
                <div style="text-align: center;">
                    <img src="img/image_homeless2.jpg" class="good1">
                    </div>
                
                <h3>Transitional Housing for Youth:</h3>
                <ul>
                    <li>Participants Are Between the Ages of 16 to 21</li><br>
                    <li>Program Participation Can Be as Long as 2 Years</li><br>
                    <li>Participants Are Required to Work or Attend School</li><br>
                    <li>Supportive and Preventive Services</li><br>
                    <li>Skills to Be a Responsible Tenant and Community Member</li><br>
                    <li>Individuals Are Required to Pay Utilities and Program Fees</li>
                ...
                <div style="text-align: center;">
                    <img src="img/image_homeless3.jpg" class="good1">
                    </div>
                ...
                <p>For information on Project NOW's traditional property rentals <a href="#property">please click here</a>.</p>
                ...
                <p>As part of Project NOW's commitment to fighting and ending the conditions which cause homelessness, we are the lead agency in the Northwestern Illinois Continuum of Care. The Continuum, covering a region of fifteen (15) counties in Illinois, is comprised of housing, social service, and employment partners in the private, public, and nonprofit sectors.</p>
            </div>
